      ...
      '<div class="consent-modal">' +
        ...
        '<div class="consent-category">' +
          '<div class="consent-category__header">' +
            '<div><span class="consent-category__name"><i class="ph ph-lock-simple"></i> Cookies essentiels</span><span class="consent-category__badge">Toujours actifs</span></div>' +
        ...
        '<div class="consent-category">' +
          '<div class="consent-category__header">' +
            '<span class="consent-category__name"><i class="ph ph-chart-bar"></i> Cookies analytiques</span>' +
        ...
        '<div class="consent-category">' +
          '<div class="consent-category__header">' +
            '<span class="consent-category__name"><i class="ph ph-megaphone"></i> Cookies marketing</span>' +
