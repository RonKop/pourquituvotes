#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Génère et insère Rennes dans app.js."""
import re

VILLE_ID = "rennes"
VILLE_NOM = "Rennes"
VILLE_CP = "35000"
ELECTION_ID = "rennes-2026"

CANDIDATS = [
    {"id": "appere", "nom": "Nathalie App\u00e9r\u00e9", "liste": "Rennes solidaire (PS/EELV/PCF/UDB)", "programmeUrl": "#", "programmeComplet": True, "programmePdfPath": None},
    {"id": "mesmeur", "nom": "Marie Mesmeur", "liste": "LFI", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
    {"id": "compagnon", "nom": "Charles Compagnon", "liste": "Vivre Rennes ! (Horizons)", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
    {"id": "trousseau", "nom": "Thomas Rousseau", "liste": "L'espoir rennais (LR)", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
    {"id": "masson", "nom": "Julien Masson", "liste": "RN/UDR", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
    {"id": "rabate", "nom": "Ulysse Rabat\u00e9", "liste": "Rennes commune (ex-LFI)", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
    {"id": "chirazi", "nom": "Sandra Chirazi", "liste": "Lutte Ouvri\u00e8re", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
    {"id": "darcissac", "nom": "Victor Darcissac", "liste": "NPA-R\u00e9volutionnaires", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
    {"id": "duclos", "nom": "Erell Duclos", "liste": "R\u00e9volution permanente", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
    {"id": "pernot", "nom": "Morgane Pernot-Goarvot", "liste": "Parti des travailleurs", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
    {"id": "melan", "nom": "Yan M\u00e9lan", "liste": "\u00c9quinoxe", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
]
...
SRC_APPERE_UNI = ("Unidivers, f\u00e9vrier 2026", "https://unidivers.fr/")
SRC_APPERE_RIA = ("Rennes Infos Autrement, f\u00e9vrier 2026", "https://www.rennes-infos-autrement.fr/")
SRC_APPERE_TVR = ("TVR, f\u00e9vrier 2026", "https://www.tvr.bzh/")
SRC_APPERE_FB = ("France Bleu Armorique, f\u00e9vrier 2026", "https://www.francebleu.fr/")
SRC_MESMEUR_TVR = ("TVR, janvier 2026", "https://www.tvr.bzh/")
SRC_MESMEUR_FB = ("France Bleu Armorique, janvier 2026", "https://www.francebleu.fr/")

PROPS = {
    # === SECURITE ===
    ("securite", "police-municipale", "appere"): (
        "Recrutement de 60 policiers municipaux suppl\u00e9mentaires et cr\u00e9ation d'une police m\u00e9tropolitaine des transports",
        *SRC_APPERE_UNI
    ),
    ("securite", "videoprotection", "appere"): (
        "D\u00e9ploiement de 80 nouvelles cam\u00e9ras de vid\u00e9osurveillance",
        *SRC_APPERE_UNI
    ),

    # === TRANSPORTS ===
    ("transports", "tarifs-gratuite", "appere"): (
        "Gratuit\u00e9 des transports en commun pour les \u00e9tudiants boursiers",
        *SRC_APPERE_RIA
    ),
    ("transports", "tarifs-gratuite", "mesmeur"): (
        "Gratuit\u00e9 des transports en commun pour les moins de 26 ans",
        *SRC_MESMEUR_FB
    ),

    # === LOGEMENT ===
    ("logement", "logement-social", "appere"): (
        "500 logements sociaux par an, 300 logements \u00e0 loyers mod\u00e9r\u00e9s et 600 en accession solidaire",
        *SRC_APPERE_RIA
    ),
    ("logement", "logements-vacants", "appere"): (
        "R\u00e9quisition des b\u00e2timents durablement vacants pour cr\u00e9er du logement",
        *SRC_APPERE_UNI
    ),
    ("logement", "encadrement-loyers", "appere"): (
        "Plafonnement des loyers du parc priv\u00e9 et instauration d'un permis de louer pour garantir des logements dignes",
        *SRC_APPERE_UNI
    ),
    ("logement", "acces-logement", "mesmeur"): (
        "Cr\u00e9ation d'une brigade municipale anti-probl\u00e8mes de logement",
        *SRC_MESMEUR_TVR
    ),

    # === EDUCATION ===
    ("education", "cantines-fournitures", "appere"): (
        "Plan anti-gaspillage dans les cantines, augmentation du bio, r\u00e9duction progressive du plastique site par site",
        *SRC_APPERE_RIA
    ),

    # === SANTE ===
    ("sante", "centres-sante", "appere"): (
        "Cr\u00e9ation de centres de sant\u00e9 de quartier et d'une mutuelle municipale. Maintien des activit\u00e9s de soins sur le site de l'h\u00f4pital Sud",
        *SRC_APPERE_UNI
    ),

    # === SOLIDARITE ===
    ("solidarite", "aide-sociale", "appere"): (
        "Cr\u00e9ation de restaurants seniors dans les quartiers et d'un guichet unique pour les jeunes",
        *SRC_APPERE_RIA
    ),
}
