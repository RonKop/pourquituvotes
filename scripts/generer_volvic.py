#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Génère et insère Volvic dans app.js."""
import re

VILLE_ID = "volvic"
VILLE_NOM = "Volvic"
VILLE_CP = "63530"
ELECTION_ID = "volvic-2026"

CANDIDATS = [
    {"id": "thevenot", "nom": "Laurent Th\u00e9venot", "liste": "Vivons Volvic (LDVC)", "programmeUrl": "#", "programmeComplet": False, "programmePdfPath": None},
]
...
# Pas de propositions connues pour l'instant — programmes non encore publiés
PROPS = {}
